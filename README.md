...
**A cozy 3D ant-farm sim, rendered on three.js.**
No game engine, no asset files — every mesh, texture, sound and note of music
is generated by code at load time. The renderer began as a hand-written WebGL2
engine and was migrated onto three.js; the shaders are still this project's
own, all 34 of them.
...
![JavaScript](https://img.shields.io/badge/JavaScript-18.5k%20lines-f7df1e?style=flat-square&logo=javascript&logoColor=black)
...
tonemap and grade → FXAA with contrast-adaptive sharpening. Every pass is a
RawShaderMaterial carrying this project's own GLSL — three.js supplies the
context, render targets and state, not the shading.
...
src/gl.js           GL context, loss handling, 3D textures, SDF bake
src/three_post.js   render targets and fullscreen passes on three
src/three_batch.js  instanced batches, materials, static meshes
...
| | |
|---|---|
| ✅ | Play it, here or from your own local copy |
| ✅ | Read the source, learn from it, modify your own copy privately |
| ✅ | Quote excerpts with attribution, to discuss or teach |
| ❌ | Redistribute it, mirror it, or host it anywhere else |
| ❌ | Use it commercially, in whole or in part |

The source is public so you can play it and read it — not because it is free to
take. For anything beyond the above, ask.
